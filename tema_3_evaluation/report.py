    ...
    <div class="card">
        ...
        <div class="scores-row">
            <div class="score-box" style="border-color:{c1}">
                <div class="score-label">Relevanta VAIP</div>
        ...
        <div class="response-section">
            <div class="response-label">Raspuns LLM</div>
...
<head>
    ...
    <title>Raport Evaluare — VAIP Assistant</title>
...
<div class="container">
    ...
    <div class="footer">VAIP — Visual Asset Intelligence Platform — Evaluation Report</div>
</div>
<script>
